...
for file in ${files[*]}
do
    cat "$file.csv" | grep "4194304" -m 4 | awk -F ";" '{print $5 " " $10}' | awk '{gsub(/,/,".")}1'  > "$file.dat"
done
gnuplot << eor
    set terminal pngcairo size 1200, 600
    set output '3.1.png'
...
for file in ${files[*]}
do
    cat "$file.csv" | grep "4194304" -m 4 | awk -F ";" '{print $5 " " $15}' | awk '{gsub(/,/,".")}1'  > "$file.dat"
done
gnuplot << eor
    set terminal pngcairo size 1200, 600
    set output '3.2.png'
...
for file in ${files[*]}
do
    cat "$file.csv" | grep "" -m 12 | awk -F ";" '{print $4 " " $9}' | awk '{gsub(/,/,".")}1'  > "$file.dat"
done
gnuplot << eor
    set terminal pngcairo size 1200, 600
    set output '4.1.png'
...
for file in ${files[*]}
do
    cat "$file.csv" | grep "" -m 12 | awk -F ";" '{print $4 " " $14}' | awk '{gsub(/,/,".")}1'  > "$file.dat"
done
gnuplot << eor
    set terminal pngcairo size 1200, 600
    set output '4.2.png'
